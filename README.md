...
Running and testing the project can be done by importing the project into Android Studio and running the app and tests as per standard procedure. The code is also available in [GitHub](https://github.com/kk2013/CatPics) 
